...
const Experience = () => {
  ...
  -Developed a full-stack blog website utilizing HTML, CSS, and JavaScript for the frontend, and SQL and PHP for the backend.<br/>
  -Designed and implemented an admin panel to enhance management capabilities, streamlining content moderation and user management processes.<br/>
  -Gained hands-on experience in full-stack development, working on both client-side and server-side components.<br/>
  -Collaborated with a team of developers to deliver a functional and user-friendly web application within a tight timeline.<br/>
        </p>
      </div>
